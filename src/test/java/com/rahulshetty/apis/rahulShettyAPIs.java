...
public class rahulShettyAPIs {
   ...
   // public static Request request;
    ...
    @Test(priority =1)
    public void addNewPlaceIntoServerWithAccuracyAsNull() throws IOException {
        ...
        String scope = response.jsonPath().getString("accuracy");
        Assert.assertEquals(scope, null);
        logger.info("tried to add new server with accuracy as null");

    }

    @Test(priority =2)
    public void addNewPlaceIntoServerWithAccuracyAsLargeInteger() throws IOException {
        ...
        Assert.assertEquals(name, "prashan");
        logger.info("tried to add new server with accuracy as large integer");
    ...
    @Test(priority =4)
    void getExistingPlaceDetailsFromServerwithoutKeyInUrl() throws IOException {
        RequestSpecification httpRequest = given();
        String final_url = "/maps/api/place/get/json?place_id=" + placeId;
        Response response = httpRequest.request(Method.GET, final_url);
        String responseBody = response.getBody().asString();
        System.out.println("Response Body is:" + responseBody);
        //logger.info("tried to get place details from server without key in url");
    }

    @Test(priority =5)
    void getExistingPlaceDetailsFromServerwithoutPlaceIdInUrl() throws IOException {
        RequestSpecification httpRequest = given();
        String final_url = "/maps/api/place/get/json?place_id=key=qaclick123";
        Response response = httpRequest.request(Method.GET, final_url);
        String responseBody = response.getBody().asString();
        System.out.println("Response Body is:" + responseBody);
        //logger.info("tried to get place details from the server without placeID");
    }

    @Test(priority =6)
    void getExistingPlaceDetailsFromServerwithInValidPlaceIdInUrl() throws IOException {
        RequestSpecification httpRequest = given();
        String final_url = "/maps/api/place/get/json?place_id=7df7c01c68d7e7f8d767d5e96a4eb2&key=qaclick123";
        Response response = httpRequest.request(Method.GET, final_url);
        String responseBody = response.getBody().asString();
        System.out.println("Response Body is:" + responseBody);
       logger.info("tried get placed details from the server with inavlid placeId");
    }
    ...
    @Test(priority =8)
    void getExistingPlaceDetailsFromServerAfterUpdating() throws IOException {
        RequestSpecification httpRequest = given();
        String final_url = "/maps/api/place/get/json?place_id="+placeId+"&key=qaclick123";
        Response response = httpRequest.request(Method.GET, final_url);
        String responseBody = response.getBody().asString();
        System.out.println("Response Body is:" + responseBody);
        logger.info("getting place details after updating");
    }
    ...
    @Test(priority =10)
    public void deleteTheServerWithPlaceIdNull() throws IOException {
        ...
        String status  = response.jsonPath().getString("place_id");
        Assert.assertEquals(status , null);
        logger.info("Tried deleting the server with place Id as null");
